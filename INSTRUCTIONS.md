...
1. Tâche: Modélisation ontologique en OWL et SKOS en fonction du type des données.
...
3. Tâche: Population de l'ontologie (création et description d'instances) et alimentation du thésaurus à partir de données hétérogènes :
...
4. Tâche: Exploitation du graphe de connaissances :
...
5. Tâche: L'application doit avoir une interface (minimale) pour communiquer avec ses utilisateurs cibles, illustrant le cas d’usage. 
